            ...
            <ul class="mt-16 pb-12 line-bt">
                ...
                <li>
                    <a href="#" class="mt-16 d-flex justify-content-between align-items-center">
                        ...
                        <span class="text-secondary d-flex gap-12 align-items-center">{{auth()->user()->email}} </span>
                    </a>
                </li>
                 <li>
                    <a href="#" class="mt-16 d-flex justify-content-between align-items-center">
                        <p class="text-small">Mobile/Phone No.</p>
                        <span class="text-secondary d-flex gap-12 align-items-center">{{auth()->user()->mobile_no}} </span>
                    </a>
                </li>
