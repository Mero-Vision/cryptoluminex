                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card-body px-25">
                                <h4 class="banner-feature__heading text-light mt-4">Send/Receive Crypto Now
                                </h4>
                    ...
                    <div class="tab-pane fade show active" id="favorites" role="tabpanel">
                        <div class="wallerContainer">
                            ...
                            <div class="overflow-auto pb-16">
                                <ul>
                                    <li>
                                        <a href="{{ url('wallet/usdt') }}" class="coin-item style-1 gap-12 bg-surface">
                            ...
                            <div class="overflow-auto pb-16">
                                <ul>
                                    <li>
                                        <a href="{{ url('wallet/btc') }}" class="coin-item style-1 gap-12 bg-surface">
                            ...
                            {{-- -------------- ETH Card -------------- --}}
                             ...
                             <div class="overflow-auto pb-16">
                                <ul>
                                    <li>
                                        <a href="{{ url('wallet/eth') }}" class="coin-item style-1 gap-12 bg-surface">
