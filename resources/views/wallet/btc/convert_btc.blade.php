        ...
        <div class="bg-menuDark tf-container">
            ...
            <div class="row">
                <div class="col-md-12 settings">
                    ...
                    <div class="cryp-icon">
                        <img src="{{ url('assets/img/icons/18.png') }}" class='mt-10 d-block mx-auto' alt="" style="width: 50px">
                    </div>
                    <h5 class="text-center text-light m-2">Convert Bitcoin</h5>

                    <form action="{{ url('wallet/convert/btc') }}" method="post">
                        @csrf

                        <input type="hidden" id="availableBalance" name="available_balance"
                            value="{{ $btcBalance->dollar_balance }}" />

                        <input type="hidden" name="balance_id" value="{{ $btcBalance->id }}" />


                        <div class="mb-3 mt-3">
                            <p class="text-light">BTC Availance Balance</p>
                            <div class="input-group" style="display: flex; align-items: center; margin-top: 10px;">
                                <span class="input-group-text bg-secondary text-light"
                                    style="padding: 10px 20px; border: 1px solid #ccc; border-right: none; border-radius: 4px 0 0 4px;">BTC</span>
                        ...
                        <p class="text-light">
                            Available: <span id="usdBalance">${{ $btcBalance->dollar_balance }}</span> USD
            ...
            <div class="container settings">
                    ...
                    <p class="p-3 px-4 text-light mt-3">
                        You have the option to directly convert BTC to USDT or ETH. Please input the desired amount from your
