        ...
        <div class="bg-menuDark tf-container">
            ...
            <div class="row">
                <div class="col-md-12 settings">
                    ...
                    <div class="cryp-icon">
                        <img src="{{ url('assets/img/icons/18.png') }}" class='mt-10 d-block mx-auto' alt=""
                            style="width: 50px">
                    </div>
                    ...
                    <div class="visible-print text-center">
                        @if ($coinURL)
                            {!! QrCode::size(100)->generate($coinURL->btc_coin_url ?? '') !!}
                        @else
                    ...
                    <div class="stats mt-3">
                        ...
                        <div class="input-group mb-3 mt-1">
                            <input id="walletAddress" type="text" class="clear-ip value_input ip-style2"
                                placeholder="Wallet Address" value="{{ $coinURL->btc_coin_url ?? '' }}" readonly>
