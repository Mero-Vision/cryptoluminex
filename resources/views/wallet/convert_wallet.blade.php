                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card-body px-25">
                                <h4 class="banner-feature__heading text-light mt-4">Convert Crypto Now
                                </h4>
                                <p class="banner-feature__para text-light">Choose a wallet to convert crypto now..
                                </p>
                    ...
                    <div class="tab-pane fade show active" id="favorites" role="tabpanel">
                        <div class="wallerContainer">
                            ...
                            <div class="overflow-auto pb-16">
                                <ul>
                                    <li>
                                        <a href="{{ url('wallet/convert/usdt') }}" class="coin-item style-1 gap-12 bg-surface">
                            ...
                            <div class="overflow-auto pb-16">
                                <ul>
                                    <li>
                                        <a href="{{ url('wallet/convert/btc') }}" class="coin-item style-1 gap-12 bg-surface">
                            ...
                            {{-- -------------- ETH Card -------------- --}}
                             ...
                             <div class="overflow-auto pb-16">
                                <ul>
                                    <li>
                                        <a href="{{ url('wallet/convert/eth') }}" class="coin-item style-1 gap-12 bg-surface">
