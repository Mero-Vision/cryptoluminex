        ...
        <div class="bg-menuDark tf-container">
            ...
            <div class="row">
                <div class="col-md-12 settings">
                    ...
                    <h5 class="text-center text-light m-2">Convert ETH</h5>

                    <form action="{{ url('wallet/convert/eth') }}" method="post">
                        @csrf

                        <input type="hidden" id="availableBalance" name="available_balance"
                            value="{{ $ethBalance->dollar_balance }}" />

                        <input type="hidden" name="balance_id" value="{{ $ethBalance->id }}" />


                        <div class="mb-3 mt-3">
                            <p class="text-light">ETH Availance Balance</p>
                            <div class="input-group" style="display: flex; align-items: center; margin-top: 10px;">
                                <span class="input-group-text bg-secondary text-light"
                                    style="padding: 10px 20px; border: 1px solid #ccc; border-right: none; border-radius: 4px 0 0 4px;">ETH</span>
            ...
            <div class="container settings">
                    ...
                    <p class="p-3 px-4 text-light mt-3">
                        You have the option to directly convert ETH to USDT or BTC. Please input the desired amount from your
